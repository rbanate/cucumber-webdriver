...
defineSupportCode(({ Then }) => {
  ...
  Then(/^I expect that element "([^"]*)?"( not)* matches the text "([^"]*)?"$/, checkEqualsText);

  Then(/^I expect that element "([^"]*)?"( not)* contains the text "([^"]*)?"$/, checkContainsText);

  Then(/^I expect that element "([^"]*)?"( not)* contains any text$/, checkContainsAnyText);

  Then(/^I expect that element "([^"]*)?" is( not)* empty$/, checkIsEmpty);
